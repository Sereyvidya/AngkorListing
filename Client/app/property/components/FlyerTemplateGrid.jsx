    ...
    <div className="absolute inset-0 flex flex-col gap-4 p-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          {/* Make title wrap nicely instead of truncating/overflowing */}
          <div className="mt-1 line-clamp-2 text-2xl leading-tight font-semibold text-gray-900">
            {title}
          </div>
      ...
      {/* Photos fill remaining space (no weird gaps) */}
      ...
      <div className="grid grid-cols-1 gap-3">
        {(showStats || formData.description?.trim()) && (
          <div className="rounded-2xl border border-gray-200 bg-white p-4">
            ...
            {formData.description?.trim() ? (
              ...
              <div className="text-sm text-gray-500">
                Add a description to make the flyer more compelling.
              </div>
            )}
          </div>
        )}

        {/* Contact strip (same as hero) */}
